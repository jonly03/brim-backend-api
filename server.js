...
app.post("/track/:event", (req, res) => {
  if (process.env.NODE_ENV === "production") {
    // FIRST_TIME_NON_REGISTERED_USER_VISIT, NEW_USER_ACCOUNT_CREATED, REGISTERED_USER_HOME_PAGE_VISIT, REGISTERED_USER_REPEAT_VISIT, PUSH_NOTIFICATION_TRIGGERED_VISIT, COURT_VISIT, CHECKIN, CHECKOUT_BY_MOVING_AWAY_FROM_COURT, NEW_CHATROOM_MESSAGE, USER_SHARED_APP, USER_VISITED_SHOP
